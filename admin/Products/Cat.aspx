...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(".btnEdit").click(function (evt) {
            ...
            $("#ctl00_main_dlLine").val($(evt.target).closest("tr").find(".Line-Id").html());
            $(".txtName").val(name);
            $("#CatDetail").dialog("open");
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" Runat="Server">
    ...
    <p class="tip">To reorder categories, click the drag handle and move them up or down.<br />

    <asp:GridView ID="gvCats" runat="server" AutoGenerateColumns="False" GridLines="None" HeaderStyle-CssClass="row" RowStyle-CssClass="row" CssClass="mGrid" PagerStyle-CssClass="pgr" EmptyDataText="No categories have been created yet.">
        <Columns>
            ...
            <asp:BoundField ItemStyle-CssClass="Line-Id" DataField="LineId" HeaderText="Line" />
    ...
    <div id="CatDetail">
        ...
        <asp:Label runat="server" AssociatedControlID="dlLine" Text="Product Line"></asp:Label><br />
        <asp:DropDownList ID="dlLine" runat="server"></asp:DropDownList><br /><br />
