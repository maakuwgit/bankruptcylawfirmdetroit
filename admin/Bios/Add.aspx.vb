...
Partial Class admin_Bios_Add
        ...
        If Not Me.IsPostBack Then
            If Not Request("Id") Is Nothing Then
                ...
                If dt.Rows.Count > 0 Then
                    ...
                    img.Src = dt.Rows(0).Item("FSLoc").ToString()
                End If
            Else
    ...
    Protected Sub btnSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnSave.Click
        ...
        If Not Id.Value = "" Then
            Dim cmd As New SqlCommand("Update RCBio set [Name]=@Name, [Title]=@Title, [Description]=@Description, [FSLoc]=@FSLoc where Id=@Id", con)
        ...
        Else
                ...
                Dim cmd As New SqlCommand("Insert Into RCBio (Name, Title, Description) Values(@Name, @Title, @Description) SELECT SCOPE_IDENTITY()", con)
                cmd.Parameters.AddWithValue("Name", txtName.Text)
                cmd.Parameters.AddWithValue("Title", txtTitle.Text)
                cmd.Parameters.AddWithValue("Description", txtDesc.Text)
                con.Open()
