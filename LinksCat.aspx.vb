...
Partial Class Links
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
          Dim NewsDataTable As DataTable = RC4.Pull("Select *, '/LinkImg.ashx?Id=' + cast(Id as varchar(8)) as ImgSrc from RCLink where CatId = " & Website.Router.URLPartReverse(0) & "order by Id asc")
		Links.DataSource = NewsDataTable
      	Links.DataBind()
      
      	Dim CategoryDataTable As DataTable = RC4.Pull("Select * from RCLinkCat Where Id = " & Website.Router.URLPartReverse(0))
