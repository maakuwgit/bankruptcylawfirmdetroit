...
Public Class Email : Implements IHttpHandler
	...
	Dim MailingListName = GetFormValueFor(Forms.Email.MAILING_LIST, Forms.Email.DEFAULT_MAILING_LIST) 
		...
		msg.Body &="<tr><td colspan=2 style=""padding:10px;font-size:16px;font-weight:bold;background:#eee;color:#666;margin-bottom:15px;""><img src=""http://www.bankruptcylawfirmdetroit.com/images/logo.png"" /><br />Form Submission</td></tr>"
